...
public class Lead extends Person {
    ...
    public Lead(String name, long phoneNumber, String email, String companyName, Date creationDate, Date modificationDate, String userCreation, String userModification, User user) {
